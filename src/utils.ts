...
export function annotatedLineIsChanged(
  ...
  line: number,
  decorations: FoxDecorationMapping
): boolean {
...
export function formatFoxResponseElement(
  element: FoxTraceLineResult
): FoxValue {
...
export function isActiveSession(
  document: TextDocument,
  sessions: FoxActiveSessionCollection
): boolean {
