...
import { FoxDecorationsController } from "./decorations";

export function foxStickyControllerFactory(
  decorationController: FoxDecorationsController
) {
  return new FoxStickyController(decorationController);
}

export class FoxStickyController {
  constructor(private decorationController: FoxDecorationsController) {}
